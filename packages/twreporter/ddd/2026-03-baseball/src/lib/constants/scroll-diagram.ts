...
export const steps: ScrollStep[] = [
  // ── 分鏡一 ──
  // 吉力吉撈・鞏冠 > Zoom out > 影視配樂 > 平移 > 現代流行樂
  {
    to: "node__1-b-1",
    path: "direct",
    ...
    audios: [
      {
        src: "https://projects.twreporter.org/twreporter/ddd/2026-03-baseball/audios/D01/01.mp3",
        name: "味全龍「吉力吉撈・鞏冠」應援曲",
      },
      {
  ...
  { to: "node__4", path: "direct", scale: 0.5 },
  ...
  { to: "node__5", path: "direct", scale: 0.5 },
  { to: "node__6-a", path: "direct", scale: 0.5 },
